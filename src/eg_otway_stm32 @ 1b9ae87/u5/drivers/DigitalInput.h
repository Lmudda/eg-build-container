...
// a particular Port. This means you can't use DigitalInput for two inputs which have the 
...
//
// If you really can't use DigitalInput, consider a different implementation of IDigital
