...
{
public:
    static constexpr uint16_t MAX_EVENT_DATA = 64;
...
public:
    ...
    void pack(const T& val)
    {
        ...
        static_assert(sizeof(T) <= MAX_EVENT_DATA);
...
// TODO_AC Make sure Event is trivially copyable.
