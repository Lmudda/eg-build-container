...
// TODO_AC Make the portable library support Linux as well as embedded.
// Two version of Signal and other types.
// #if (__linux__ == 1)
...
public:
    ...
    void connect(Class* obj) noexcept
    {
        ...
        //m_slot = &Callback::invoke<MemFunc, Class>;
    ...
    {
        m_obj  = nullptr;
        m_slot = []([[maybe_unused]] void* data, Args... args) -> Ret 
        {
